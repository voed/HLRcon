...
package voed.voed.hlrcon.steamcondenser.steam.servers;
...
import voed.voed.hlrcon.steamcondenser.steam.packets.A2M_GET_SERVERS_BATCH2_Paket;
import voed.voed.hlrcon.steamcondenser.steam.packets.C2M_CHECKMD5_Packet;
import voed.voed.hlrcon.steamcondenser.steam.packets.M2A_SERVER_BATCH_Paket;
import voed.voed.hlrcon.steamcondenser.steam.packets.M2C_ISVALIDMD5_Packet;
import voed.voed.hlrcon.steamcondenser.steam.packets.S2M_HEARTBEAT2_Packet;
import voed.voed.hlrcon.steamcondenser.steam.packets.SteamPacket;
import voed.voed.hlrcon.steamcondenser.steam.sockets.MasterServerSocket;
            ...
            try {
                ...
                do {
                    ...
                    try {
                        ...
                        Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Request to master server " + this.ipAddress + " timed out, retrying...");
                    }
                } while(!finished);
                break;
            } catch(TimeoutException e) {
                ...
                Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Request to master server failed, retrying " + this.ipAddress + "...");
            }
        }
