...
package voed.voed.hlrcon.steamcondenser.steam.sockets;
...
import voed.voed.hlrcon.steamcondenser.steam.packets.SteamPacketFactory;
import voed.voed.hlrcon.steamcondenser.steam.packets.rcon.RCONGoldSrcRequestPacket;
import voed.voed.hlrcon.steamcondenser.steam.packets.rcon.RCONGoldSrcResponsePacket;
    ...
    public SteamPacket getReply()
        ...
        if(this.packetIsSplit()) {
            ...
            do {
                ...
                Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Received packet #" + packetNumber + " of " + packetCount + " for request ID " + requestId + ".");
        ...
        Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Received packet of type \"" + packet.getClass().getSimpleName() + "\"");
