...
public class SourceSocket extends QuerySocket {
    ...
    public SteamPacket getReply()
        ...
        if(isCompressed) {
            Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Received compressed reply of type \"" + packet.getClass().getSimpleName() + "\"");
        } else {
            Logger.getLogger("voed.voed.hlrcon.steamcondenser").info("Received reply of type \"" + packet.getClass().getSimpleName() + "\"");
        }
